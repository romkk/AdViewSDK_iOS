...
@class AdViewCustomAdView;

@protocol AdViewCustomAdViewDelegate<NSObject>

- (void)adTapped:(AdViewCustomAdView *)adView;
...
- (id)initWithDelegate:(id<AdViewCustomAdViewDelegate>)delegate
                  text:(NSString *)text
...
@property (nonatomic,assign) id<AdViewCustomAdViewDelegate> delegate;
